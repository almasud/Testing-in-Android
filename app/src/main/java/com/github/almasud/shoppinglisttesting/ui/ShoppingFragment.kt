...
import com.github.almasud.shoppinglisttesting.databinding.FragmentShoppingBinding
...
class ShoppingFragment @Inject constructor(
    ...
    private lateinit var mBinding: FragmentShoppingBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mBinding.fabAddShoppingItem.setOnClickListener {
    ...
    private fun subscribeToObservers() {
        ...
        viewModel?.totalPrice?.observe(viewLifecycleOwner) {
            ...
            mBinding.tvShoppingItemPrice.text = priceText
        }
    }

    private fun setupRecyclerView() {
        mBinding.rvShoppingItems.apply {
