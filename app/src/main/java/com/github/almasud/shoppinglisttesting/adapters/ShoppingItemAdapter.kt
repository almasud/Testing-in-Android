package com.github.almasud.shoppinglisttesting.adapters
...
class ShoppingItemAdapter @Inject constructor(
    ...
    override fun onBindViewHolder(holder: ShoppingItemViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            findViewById<TextView>(R.id.tvShoppingItemAmount).text = amountText
            val priceText = "${shoppingItem.price}€"
            findViewById<TextView>(R.id.tvShoppingItemPrice).text = priceText
        }
    }
}